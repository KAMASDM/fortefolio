import { Box, Typography, Link, Stack, IconButton, Chip } from "@mui/material";
import {
  Star as StarIcon,
  StarBorder as StarBorderIcon,
} from "@mui/icons-material";

export const CanadaTemplate = ({
  resumeData,
  formatDate,
  colorScheme,
  fontFamily,
    ...
    >
      ...
      {personalInfo.summary && (
        <Box sx={{ marginBottom: "1.5rem" }}>
          <SectionTitle title="Summary" sectionName="personalInfo" />
          <Typography
            variant="body2"
            sx={{
              color: "#4b5563",
