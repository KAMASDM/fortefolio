...
export const UsaTemplate = ({
  ...
  const SectionTitle = ({ title, sectionName, icon: IconComponent }) => (
    ...
    >
      {IconComponent && (
        <IconComponent
          sx={{ mr: "0.75rem", fontSize: { xs: "1rem", md: "1.25rem" } }}
        />
      )}
      {title}
      <IconButton
  ...
  return (
    <Box
      sx={{
        ...
        maxWidth: "800px",
        margin: { xs: "1rem", md: "2rem auto" }, // Adjusted margin for responsiveness
        padding: { xs: "1.5rem", md: "2.5rem" }, // Adjusted padding for responsiveness
        background: "white",
        borderRadius: "0.5rem", // Slightly less rounded for a more traditional feel
        boxShadow:
    ...
    >
      <Box sx={{ textAlign: "center", marginBottom: "1.5rem" }}>
        ...
        <Typography
          ...
          component="h1"
          sx={{
            fontSize: { xs: "1.75rem", md: "2rem" }, // Tailwind text-2xl / text-3xl
            fontWeight: 700, // Tailwind font-bold
        ...
        <Typography
          variant="body2"
          sx={{
            marginTop: "0.25rem", // Adjusted margin-top
            fontSize: "0.875rem", // Tailwind text-sm
            color: "#374151", // Tailwind gray-700
            textAlign: "center",
            marginBottom: "1.5rem", // More space after contact info
            "& span": {
              display: { xs: "inline", sm: "inline" }, // Keep on same line if possible, wrap naturally
              marginRight: { xs: "0.5rem", sm: "0.5rem" },
            },
          ...
          {education.map((edu, index) => (
            ...
            >
              <Box>
                ...
                <Typography
                  variant="body2"
                  sx={{ color: "#374151", fontSize: "0.95rem" }} // Tailwind gray-700
              ...
              <Typography
                ...
                sx={{
                  ...
                  textAlign: "right", // Dates often right-aligned in US resumes
                  ...pdfColorStyles,
                }}
